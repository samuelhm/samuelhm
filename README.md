...
### 🏆 **[42Jobs](https://github.com/samuelhm/42Jobs)** - Plataforma de Búsqueda de Empleo con IA
...
- 🔍 **Job Fetching**: Integración con LinkedIn vía RapidAPI, procesamiento asíncrono con Channel<T> y rate limiting
...
### 👨‍🍳 **[Philosophers](https://github.com/samuelhm/Philosophers)** - Concurrencia & Sincronización
...
| [**PStarsWrapper**](https://github.com/samuelhm/PStarsWrapper) | C# | PokerStars Card and Stack Reader for automated poker bots |
| [**42_VscodeInstallerScript**](https://github.com/samuelhm/42_VscodeInstallerScript) | Shell | Script de instalación automática de VSCode en máquinas de 42 Barcelona |
...
🌐 **Web**: [hurtadom.dev](https://hurtadom.dev)
